      ...
      <AnimatePresence>
        ...
        "
            >
              ...
              <button
                onClick={() => setMenuOpen(false)}
                className="absolute right-4 top-4 z-[60] rounded-full border border-white/10 bg-black/40 p-2 text-white backdrop-blur-md"
              >
                <X size={22} />
              </button>

              <div className="flex flex-col px-5 pt-16 pb-8">
                {/* logo */}
                <div className="mb-8">
                  <img
                    src={logo}
                  ...
                  />
                  <h2 className="mt-3 text-base sm:text-lg font-bold tracking-[0.2em] text-white">
                    CS TRAVELS
                  </h2>
                  <p className="mt-1 text-[9px] uppercase tracking-[0.4em] text-[#D4AF37]">
                    Tirupati
                  </p>
                </div>
              ...
              rounded-full
              bg-gradient-to-r from-[#D4AF37] via-[#F5D97A] to-[#D4AF37]
              py-3
