        ...
        {menuOpen && (
          <>
            ...
            >
              ...
              <div className="flex flex-col px-6 sm:px-8 pt-24 pb-10">
                {/* logo */}
                <div className="mb-10">
                  <img
                    src={logo}
                  ...
                  />
                  <h2 className="mt-4 text-lg sm:text-xl font-bold tracking-[0.2em] text-white">
                    CS TRAVELS
                  </h2>
                ...
                <div className="space-y-1">
                  {links.map((link, index) => (
                    <motion.a
                      ...
                      className="flex items-center justify-between border-b border-white/10 py-4 sm:py-5 text-[13px] sm:text-sm font-medium uppercase tracking-[0.16em] text-white/80 hover:text-[#D4AF37]"
                    >
                      {link.name}
                ...
                <motion.a
                  ...
                  className="mt-8 sm:mt-10 flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#D4AF37] via-[#F5D97A] to-[#D4AF37] py-3 sm:py-4 text-[12px] sm:text-sm font-bold uppercase tracking-[0.16em] text-black"
                >
                  <Phone size={16} />
                  Book Now
                </motion.a>
